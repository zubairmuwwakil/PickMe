...
- **PickMe is one product of four, not the brand of the whole thing** (E1 supersedes D1). The unifier is **Inunity** (named 2026-08-18); PickMe keeps its identity as the iOS card copilot. Don't write copy that treats PickMe as the umbrella product.
