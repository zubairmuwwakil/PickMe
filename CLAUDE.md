...
- Test/CI health (verified 2026-08-16): `Engine` 149 tests and `Store` 60 tests green; CI gate lives at `.github/workflows/ci.yml`. The former `BenefitsLoaderTests` staleness and the missing CI are both resolved — treat fixture changes as API changes and keep the gate green.
