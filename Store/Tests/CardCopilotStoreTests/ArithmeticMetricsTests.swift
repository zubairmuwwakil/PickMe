...
final class ArithmeticMetricsTests: XCTestCase {
    ...
    func testPointsRowInsideOneUnitCounts() throws {
        ...
        try log.settle(row, cardUsed: "amex-cobalt", observedCategory: "grocery",
    ...
    func testCashBackRowIsCheckedToTheCentNotToTheDollar() throws {
        ...
        try log.settle(row, cardUsed: "wealthsimple-vip", observedCategory: "grocery",
    ...
    func testRowsMissingEitherRewardUnitAreExcluded() throws {
        ...
        try log.settle(legacy, cardUsed: "amex-cobalt", observedCategory: "grocery",
                        observedRewardUnits: 700, missClass: nil, note: nil)
        let unreadStatement = try log.record(prediction())
        try log.settle(unreadStatement, cardUsed: "amex-cobalt", observedCategory: "grocery",
    ...
    func testWrongCategoryRowIsExcludedFromTheArithmeticCheck() throws {
        ...
        try log.settle(row, cardUsed: "amex-cobalt", observedCategory: "wholesaleClub",
    ...
    func testArithmeticBarDemandsEveryEligibleRow() throws {
        ...
        try log.settle(good, cardUsed: "amex-cobalt", observedCategory: "grocery",
                        observedRewardUnits: 700, missClass: nil, note: nil)
        try log.settle(bad, cardUsed: "amex-cobalt", observedCategory: "grocery",
