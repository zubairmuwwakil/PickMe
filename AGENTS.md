...
| [`merchant MCC architecture`](docs/superpowers/specs/2026-09-04-merchant-mcc-graph-seed-design.md) | changing merchant MCC seeds, learning, community evidence, providers, or Purchase Route MCC semantics |
